    ...
    <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php foreach ($get_pasien_rwt as $key) { ?>
                   
                <tr>
                  <td> <?php echo $key->id_pasien_rawat_jalan;?></td>
                  <td> <?php echo $key->id_pasien;?></td>
                  <td> <?php echo $key->nama_pasien;?></td>
                  <td> <?php echo $key->kelas;?></td>
                  <td> <?php echo $key->pembayaran;?></td>
                  <td> <?php echo $key->Paket;?></td>
                  <td> <?php echo $key->no_asuransi;?></td>
<td>


<a data-toggle="modal" data-target="#modal_edit<?php echo $key->id_pasien_rawat_jalan; ?>" data-id="<?php echo $key->id_pasien_rawat_jalan; ?> " class="btn btn-warning pull-right" style="margin-left: 10px">edit </a>

<a data-toggle="modal" data-target="#modal_hapus<?php echo $key->id_pasien_rawat_jalan; ?>" data-id="<?php echo $key->id_pasien_rawat_jalan; ?> " class="btn btn-danger pull-right" style="margin-left: 10px">hapus </a>
...
<?php foreach ($get_pasien_rwt as $key) { ?>
 ...
 <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modal_hapus<?php echo $key->id_pasien_rawat_jalan; ?>" class="modal fade">
...
<?php foreach ($get_pasien_rwt as $key) { ?>
 ...
 <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modal_edit<?php echo $key->id_pasien_rawat_jalan; ?>" class="modal fade">
   <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
